export default function Donut() {
  return (
    <div className="border border-neutral-200 rounded-3xl p-7 bg-white">
      <div>
        <div className="text-lg">
          <span className="font-bold">In high demand</span>
        </div>
        <div className="font-medium text-neutral-500">Top 5</div>
      </div>
      ...
      <div>
        <div className="flex gap-1 items-center">
          ...
          <div>
            ...
            <div className="text-sm font-bold">Infographie</div>
          </div>
        </div>
      </div>
    </div>
