...
export function PageAuthEmployerRegister() {
        ...
        <div className="py-16 lg:py-32 relative flex-1 flex items-center">
            ...
            <Section className="flex items-center flex-col lg:flex-row gap-12 lg:px-16">
                ...
                >
                    ...
                    <div className="mt-8 text-center flex items-center text-sm font-medium *:*:underline *:*:text-primary *:*:font-semibold">
                        <div>
                            {t("Already registered")} ?{" "}
                            <Link to="/employer/login">{t("Sign in")}</Link>
                        </div>
                    </div>
                </form>
            </Section>
